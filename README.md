...
- [Pipeline GitHub → Harbor → Coolify → OVH](./docs/deploy-pipeline.md) — CI/CD production
- [Sandbox OVH](./docs/sandbox-ovh.md) — Déployer l'API rapidement (Docker direct, sans Harbor)
